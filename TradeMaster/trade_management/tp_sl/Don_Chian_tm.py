...
from TradeMaster.helpers.indicators import calculate_donchian_channel_and_atr
import pandas as pd

class Donn_China_RR_TradeManagement:
    def __init__(self, strategy, atr_multiplier = 3, atr_period = 14, channel_period = 20,risk_reward_ratio = 1.5):
