"""Read and write Trademaster config file
...
trademaster_root = os.path.expanduser('~/.Trademaster')
...
class GlobalConfig(BaseModel):
    ...
    @staticmethod
    def load(config_yaml: str = '~/.Trademaster/config.yaml'):
        ''' Load Trademaster configuration '''
        try:
    ...
    def save(self, config_yaml: str = '~/.Trademaster/config.yaml'):
        ''' Save Trademaster configuration '''
...
if 'pytest' not in sys.modules:
    ...
    assert os.path.exists(os.path.expanduser('~/.Trademaster/config.pytest.yaml'))
    config = GlobalConfig.load('~/.Trademaster/config.pytest.yaml')
