...
from TradeMaster.backtest import calculate_trade_stats
from TradeMaster.broker import Broker, BrokerAccount
from TradeMaster.datasource import QuoteSource
from TradeMaster.trader import (BacktestLog, BacktestRunner, StrategyManager,
                              TradePlan)
from TradeMaster.trader.scheduler import run_trader_after_backtest
...
def show_create_trade_plan_form() -> TradePlan | None:
    ...
    st.info(
        ...
        'See [Trading](https://dodid.github.io/Trademaster/trading/) for more details.')
