...
from TradeMaster.backtest.core._stats import compute_drawdown_duration_peaks
from TradeMaster.backtest.core._util import _Array, _as_str, _Indicator, try_
from TradeMaster.backtest.core.lib import (OHLCV_AGG, SignalStrategy,
                                         TrailingStrategy, barssince,
                                         compute_stats, cross, crossover,
                                         plot_heatmaps, quantile,
                                         random_ohlc_data, resample_apply)
from TradeMaster.backtest.core.test import EURUSD, GOOG, SMA
...
class TestPlot(TestCase):
    ...
    def test_resample(self):
        bt = Backtest(GOOG, SmaCross)
        bt.run()
        import Trademaster.backtest.core._plotting
        with _tempfile() as f, \
                patch.object(Trademaster.backtest.core._plotting, '_MAX_CANDLES', 10), \
